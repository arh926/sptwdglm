...
All samplers use Metropolis Adjusted Langevin Algorithm (MALA, see Girolami and Calderhead, 2011 https://rss.onlinelibrary.wiley.com/doi/10.1111/j.1467-9868.2010.00765.x). Variable selection is performed using the function `FDR.R` on the model coefficients.
