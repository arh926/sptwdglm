...
#'
#' Bayesian Variable Selection for the Double Generalized Linear Model: \eqn{\log(\mu({\bf s}))=x(\{\bf s})^T\beta+f({\bf s})}^Tw({\bf s}) and \eqn{\log(\phi)=z^T\gamma}. Parameters not listed below are optional.
#'
